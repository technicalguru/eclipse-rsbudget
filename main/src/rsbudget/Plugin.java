...
public class Plugin {
	...
	/** The release site */
	public static final String RELEASE_CHANNEL = "https://download.ralph-schuster.eu/rsbudget/releases/";
	/** The snapshot site */
	public static final String SNAPSHOT_CHANNEL = "https://download.ralph-schuster.eu/rsbudget/snapshots/";
